...
! function (t) {
       ...
       if (T.c) {
          ...
          if (r) {
             var i = n.getStyle,
                ...
                a = i(t, A.E);
             if (a) {
                var u = a.split(A.i).map(C); - 1 === u.indexOf(r) && o(t, A.E, u.concat(r).join(A.i))
             } else o(t, A.E, r)
          }
       }
    }
       ...
       if (T.c) {
          ...
          if (r) {
             var i = n.getStyle,
                o = n.setStyle,
                a = i(t, A.E);
             a && -1 !== a.indexOf(r) && o(t, A.E, a.split(A.i).map(C).filter(function (t) {
                return t !== r
             }).join(A.i))
          }
       }
             ...
             return function (t, e) {
                ...
                switch (e) {
                   case E.i:
                      ...
                      return r(i);
                   case E.k:
                      var o = [u(G, t), u(W, t), u(H, t)];
                      return r(o);
                   case E.j:
                      var a = [u(X, t), u(q, t), u(B, t)];
                      return r(a);
                   case E.l:
                      var c = [u(U, t), u(Q, t)];
                      return {
          ...
          var n = t.element,
             ...
             f = function (t, e, n) {
                ...
                switch (r) {
                   ...
                   case E.k:
                      return void 0 !== d && (h = c(h, G, A.s, d + a)), void 0 !== p && (h = c(h, W, A.t, p + s)), void 0 !== v && (h = c(h, H, A.u, v + l)), h;
                   case E.j:
                      return void 0 !== d && (h = c(h, X, A.p, d + a)), void 0 !== p && (h = c(h, q, A.q, p + s)), void 0 !== v && (h = c(h, B, A.r, v + l)), h;
                   case E.l:
    ...
    var h, g, y, m = n(20),
       ...
       M = Object.freeze((h = {}, r(h, E.d, A.c), r(h, E.e, A.e), r(h, E.h, A.h), h)),
       ...
       var C = e.frame = function () {
          ...
          N = s(function (e) {
             function n() {
                ...
                if (i)
                   for (C(n), e = M(), t = i; t--;)(r = u[t]) && r.render(e)
             }
             var r = {
                ease: f.ease[1],
                from: 0,
             ...
             e.init = function (t) {
                ...
                this.active || (this.start || (this.start = M()), this.active = !0, function (t) {
                   1 === u.push(t) && C(n)
                }(this))
             }, e.stop = function () {
    ...
    n(85), n(87), n(89), n(90), n(235), n(236), n(237), n(238), n(239), t.exports = n(240)
 }, function (t, e, n) {
    var r = n(1);
    ...
    r.define("edit", t.exports = function (t, e, n) {
       ...
       return v ? p() : l.search ? (/[?&](edit)(?:[=&?]|$)/.test(l.search) || /\?edit$/.test(l.href)) && p() : s.on(d, i).triggerHandler(d), {}
    })
 }, function (t, e, n) {
    var r = n(1),
       i = n(91);
       ...
       c = function (t, e) {
          ...
          if (y && !m)
             for (var T = 0, k = o.length; T < k; T++) {
                ...
                for (var M = (h - b) / w, P = y.config.easing, L = Object(u.a)(P, M), D = 0, R = o.length; D < R; D++) {
                   var z = o[D],
                      V = y.config[z],
                      N = (m.config[z] - V) * L + V;
                   A[z] = N
    ...
    e.a = (i = {}, r(i, v.x, C()), r(i, v.y, M()), r(i, v.d, C()), r(i, v.c, M()), r(i, v.n, C(!1)), r(i, v.m, M(!1)), r(i, v.z, C()), r(i, v.A, M()), r(i, v.f, h({}, O, {
       types: "click"
    })), r(i, v.k, h({
       types: "click"
    }, O, {
       ...
       handler: function (t) {
          ...
          switch (u) {
             case v.B:
                A = I ? Math.min(y, window.innerWidth) / window.innerWidth : Math.min(b, window.innerHeight) / window.innerHeight;
                break;
             case v.o:
                var C = S(),
                   M = C.scrollLeft,
                   ...
                   L = C.scrollWidth,
                   D = C.scrollHeight;
                A = I ? Math.min(M + _, L) / L : Math.min(P + j, D) / D;
                break;
             case v.e:
             default:
                T = Object(d.i)(o, s);
       ...
       handler: function (t) {
          ...
          if (m === v.B) {
             var C = k ? u / g : c / y;
             return C !== o.scrollPercent && n.dispatch(Object(p.parameterChanged)(w, C)), {
                scrollPercent: C
             }
          }
          var M = Object(d.i)(i, w),
          ...
          return N !== o.scrollPercent && n.dispatch(Object(p.parameterChanged)(M, N)), {
             scrollPercent: N
          }
       }
